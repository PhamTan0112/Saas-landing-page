      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
          ...
          <Paragraph className="mt-8">
            Empower your Business with AI – Turn data into power, and challenges
            into opportunities. From automating workflows and boosting
            efficiency to generating sharp insights that drive smarter
            decisions. AI doesn’t just help you move faster — it ensures you’re
            moving in the right direction, so every step is a leap forward.
          </Paragraph>
